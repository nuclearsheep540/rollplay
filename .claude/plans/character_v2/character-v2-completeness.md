...
| **PR 5** | A.7 + A.8 | Invocations + Metamagic catalogues. Once they exist, ADD the deferred PR2 class choices to `class_choices.json`: Warlock Invocations/Pact Boon (`type: invocation`), Sorcerer Metamagic (`type: metamagic`). | S |
