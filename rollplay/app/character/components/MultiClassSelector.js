  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-sm font-semibold" style={{ color: THEME.textAccent }}>
        ...
        {characterClasses.map((classInfo, index) => (
          ...
          >
            ...
            <div className="flex-1">
              <div className="text-sm font-medium mb-1" style={{ color: THEME.textSecondary }}>Class</div>
      ...
      {addingClass ? (
        ...
        >
          <div className="text-sm font-medium mb-2" style={{ color: THEME.textOnDark }}>Add New Class</div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-4 py-2 rounded-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed border"
              style={{
            ...
            <button
              ...
              className="px-4 py-2 rounded-sm transition-colors border"
              style={{
                backgroundColor: THEME.bgSecondary,
                borderColor: THEME.borderDefault,
                color: THEME.textOnDark
        ...
        canAddClass && !disabled && (
          <button
            ...
            className="w-full py-3 border-2 border-dashed rounded-sm transition-colors flex items-center justify-center gap-2 hover:opacity-80"
      ...
      {calculatedTotal !== totalLevel && (
        ...
        >
          Warning: Class levels ({calculatedTotal}) don&apos;t match total level field ({totalLevel})
        </div>
      )}
    </div>
  )
