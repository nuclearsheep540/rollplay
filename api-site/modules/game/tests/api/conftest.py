...
"""TestClient + dependency-override harness for game API tests.
...
Copied from the characters harness rather than shared: the two suites want the
same two overrides and nothing else, and a common fixture module would couple
them for no gain.
"""
