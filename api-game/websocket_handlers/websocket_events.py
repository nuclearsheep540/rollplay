...
class WebsocketEvent():
    ...
    @staticmethod
    def _get_character_name(room_id: str, player_name: str) -> str:
        """Resolve a player's character name from room metadata, fallback to player name."""
        if not player_name:
            return "Unknown"
    ...
    @staticmethod
    def _character_name_for_prompt(room_id: str, player_name: str) -> str:
        return WebsocketEvent._get_character_name(room_id, player_name)
    ...
    async def dice_prompt(websocket, data, event_data, player_name, client_id, manager):
        ...
        target_character = WebsocketEvent._character_name_for_prompt(client_id, prompted_player)
    ...
    async def initiative_prompt_all(websocket, data, event_data, player_name, client_id, manager):
        ...
        character_targets = [
            WebsocketEvent._character_name_for_prompt(client_id, player)
